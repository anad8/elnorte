...
class Character(pygame.sprite.Sprite):
 ...
 def update(self):
     ...
     for snake in snakeGroup:
         snake.kill()
     if bg == pygame.image.load("part1.png"):
         snake.kill()
     ...
     if self.rect.right > WIDTH:
         ...
         bg = pygame.image.load("part2.png") #screen2
     if bg == pygame.image.load("part2.png"):
         ...
         for patrol in patrolGroup:
             patrol.kill()
         for l in range(4):
             l = Cactus1(random.randint(0,920), random.randint(80,800))
             cactusGroup.add(l)

         for k in range(4):
             k = Snake(random.randint(0,900), random.randint(80,800))
             snakeGroup.add(k)

         for p in range(4):
             p = BorderPatrol(random.randint(0,900), random.randint(80,800))
             patrolGroup.add(p)
         house.kill()
...
for j in range(4):
   j = Snake(random.randint(500,900), random.randint(80,1500))
   snakeGroup.add(j)

for m in range(4):
   m = BorderPatrol(random.randint(500,900), random.randint(80,1500))
   patrolGroup.add(m)
